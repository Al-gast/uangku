...
export function LoginForm({ next = "/dashboard" }: { next?: string }) {
  return (
    <form action={login} className="mt-8 space-y-4">
      ...
      <button className="flex min-h-13 w-full items-center justify-center rounded-control bg-accent px-5 font-bold text-accent-foreground transition-colors hover:bg-accent-strong active:scale-[0.98]">
        Masuk
      </button>
